        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <form:form modelAttribute="modalCustomerContract" method="post" action="/contract/customer">
                        <div class="row">
                            <div class="col">
                                <form:input path="fullName" cssClass="form-control" placeholder="Họ và tên"/>
                            </div>
                            <div class="col">
                        ...
                        <form:input path="phone" cssClass="form-control mt-3" placeholder="Số điện thoại"/>
                        <form:input path="demand" cssClass="form-control mt-3" placeholder="Nội dung"/>
